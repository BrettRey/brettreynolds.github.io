...
A profile account of how large language models participate in stabilizing routes to truth, including testimony, coherence, measurement, intervention, and correction.

## Public Links

- Primary resource: <https://philarchive.org/rec/REYTPW>
- Preprint: <https://philarchive.org/rec/REYTPW>

## Export Note

This public OKF concept is generated from public-safe configuration fields.
Internal project notes, review strategy, and blind-review-sensitive state are not exported.
