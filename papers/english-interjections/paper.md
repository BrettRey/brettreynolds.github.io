...
Interjections typically carry exclamatory or imperative force: *ouch!* expresses pain, *shh!* demands silence (Quirk et al. 1985, 88). But the pragmatic range extends beyond exclamation. Interjections greet (*hey*, and, at the boundary with routine formulae, *hello*; see Section <a href="#sec:boundaries" data-reference-type="ref" data-reference="sec:boundaries">6.3</a>), mark agreement (*yes*, *amen*), indicate understanding (*oh*, *uh-huh*), and signal backchanneling, the listener’s ongoing attention to a speaker’s turn (Dingemanse 2020; Stivers 2019).
...
I use the framework as a diagnostic ladder (Reynolds 2026). First, what’s the projection target: the field-relative inference the category is supposed to support? Second, what stable profile supports that target? Third, what network order makes the profile non-accidental? Fourth, what stabilizers, if any, keep the profile available across relevant contexts? Fifth, is any stabilizer a controller: a perturbation-sensitive process that corrects departures from the profile? Projectibility is the payoff; strict homeostasis is the final and most demanding evidential claim.
