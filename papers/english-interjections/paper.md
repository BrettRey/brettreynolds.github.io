...
The diachronic record does support the syntactic half. Gehweiler (2008, 85) finds that invocational *Jesus* “typically stands utterance-initially and – like other interjections – set apart from the rest of the utterance, or even on its own”, and argues that “only because of this syntactic isolation of the proper name – and Invited Inferencing, of course – could the secondary interjection *Jesus!* develop from the proper name”. That is evidence that syntactic isolation, together with invited inferencing, enabled a categorial change, not that prosody enabled the syntax. She also limits it: the step from *Jesus!* to *gee!* “can therefore not be explained with reference to Invited Inferencing or syntactic position” (Gehweiler 2008, 88).
