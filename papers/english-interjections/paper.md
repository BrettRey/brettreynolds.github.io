...
The object of analysis is the category position, not the membership list alone. Individual items such as *wow*, *damn*, *bruh*, and *fie* matter because they show what the category supports inference to: likely prosody, syntactic independence, limits on argumenthood, stance or response function, and possible pathways into or out of the profile.
...
Throughout, I use property cluster descriptively for the empirical pattern of co-occurring features. English interjections form a stable projectible cluster and a causal-pragmatic kind: a category whose strongest inferences concern use, stance, sequence, and uptake. Whether the cluster is homeostatic in the stricter sense remains a further maintenance hypothesis.
...
The evidential order matters. The analysis first identifies a projection target: what an analyst may infer from a form’s categorization as an interjection, and what speakers and hearers may anticipate from partial cues without categorizing at all. It then asks whether a stable profile supports that target, what network order makes the profile non-accidental, what stabilizers may maintain it, and whether any stabilizer amounts to corrective control. Only the final step would license strict homeostatic language.
