...
Your commission angle: tags are an ENCODING problem. Multiple membership is a data property; your question is how to show it with the least ink and the most information. You are hostile to added visual vocabulary that encodes nothing, and you have already objected once to grey rules on this page that appeared on every item and therefore carried zero bits. Consider small multiples, sparkline-like density marks, a matrix or table view of work by field, and direct labelling over legends. If a tag system needs a key, you probably think it has failed.
