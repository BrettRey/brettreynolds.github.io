...
This distinction places the present approach within an established socialist feasibility tradition. [Nove](https://en.wikipedia.org/wiki/Alec_Nove) (1983) asks what a feasible socialist economy would actually require rather than comparing capitalism with an institutionally unspecified ideal; Wright (2010) distinguishes desirable, viable, and achievable alternatives and treats transformation strategy as part of the analysis.
...
A socialist political movement can govern a predominantly capitalist economy and build social insurance, public services, collective bargaining, or redistribution without thereby socializing most productive ownership. [Przeworski](https://en.wikipedia.org/wiki/Adam_Przeworski)’s analysis of social democracy centres precisely on the strategic and institutional problems faced by socialist parties operating within capitalist democracy (Przeworski 1985).

The Swedish [Meidner wage-earner-fund proposal](https://en.wikipedia.org/wiki/Meidner_plan) was more directly socialist in the institutional sense because it sought to alter claims over corporate capital incrementally rather than merely redistribute current private income. The eventual funds were substantially diluted relative to the original proposal, and were later abolished; the episode is therefore especially informative about transition, coalition stability, and the political response of incumbent interests rather than the steady-state performance of a completed social-ownership system (Meidner 1978; Westerberg 2023).
...
These cases motivate an explicit layered rule. A socialist project is identified by genealogy: an organized attempt to transfer productive powers toward collectively constituted bodies in the name of recognizably socialist aims. A socialist institution is identified by structure: it actually vests some bundle of the powers listed in §1.2 in such bodies, whatever its sponsors intended. A formation can also receive two distinct descriptions. It may be indexed historically as state-socialist when a socialist project organizes extensive state ownership and economic transformation, even where effective residual authority remains concentrated in a party-state (van der Linden 2022; Kornai, Maskin, and Roland 2003). For structural comparison, a socialist formation is identified by extent: enough productive powers, over enough productive life, are effectively socialized that the configuration itself, not merely an element within it, is organized around social control.

State ownership is neither necessary nor sufficient for effective socialization. It is one possible institutional route to socialization, but only insofar as workers, citizens, communities, or other collective principals possess institutional powers of authorization, access to information, review, contestation, and replacement. A state-socialist formation can therefore have extensive state ownership but weak effective socialization, and its record can still bear on socialist transition and design rather than being expelled from the historical category. Conversely, a formation with substantially socialized productive power but no socialist self-description (a developmental state holding commanding-heights industries, a corporatist order administering investment through peak associations) categorizes by its structure, with its genealogy recorded separately; its record bears on socialist institutional design exactly to the extent that the socialized powers drove the outcome. A socialist movement whose implemented institutions socialize little, the ordinary social-democratic case, remains a socialist project governing a non-socialist formation, and its record is evidence about strategy and transition rather than about social ownership. Evidence eligibility follows the powers and mechanisms, not the label; genealogy determines what a case is evidence about only where intent shaped how the institution operated.

How much effective socialization makes a formation socialist in the structural comparative sense rather than social-democratic, corporatist, or developmental-statist is a threshold question of the same kind as capitalism’s lower boundary: no single power suffices, and the test is whether socialized control materially structures investment, enterprise governance, and residual claims across a substantial part of productive life, or instead operates as an enclave within a configuration organized otherwise. Historical indexing and structural categorization therefore answer different questions: the former preserves a formation’s place in the socialist tradition, while the latter tracks effective social control. The categories also genuinely overlap: a formation can satisfy capitalism’s structural test while socializing substantial powers, which is the hybrid space, and many actual formations live in it. The threshold question is therefore not where a sharp line falls but which powers, socialized to what extent, change which mechanisms.
...
4. Is that mechanism constitutive of the project of socialization, complementary, background, or recruited (§1.5)?

5. What outcome does the evidence identify?

6. How far may the inference travel?

The worked inferences in §§6.6–6.7 apply questions 3 through 6 as an attribution test followed by a scope restriction. The test is:

1. Define the unit, outcome, and relevant comparator or counterfactual.
2. Identify the mechanism and its observable implications.
3. Show that it operated and made a non-trivial contribution, addressing the principal plausible rival mechanisms and estimating direction and magnitude where possible.
4. Explain how its operation depended on the institutional structure under examination.
5. Examine feedback, endogenous reproduction, and correction when the claim concerns a recurring tendency or dynamic trajectory.
6. Assess robustness or transport across relevant variants and restrict the verdict accordingly.

The pair uses explicative definitions for comparative institutional analysis. They are answerable both to paradigm cases and major historical uses and to whether they distinguish cases in ways that support reliable explanation and projection. Adequacy here requires continuity with those cases and uses, discrimination among contrasts that matter for the inquiry, principled treatment of boundary cases, explanatory or projective payoff, and transparency about the field and purpose for which the category is being constructed. Other fields may require differently bounded but overlapping concepts. In this entry, the labour historian’s socialism, a family of movements and projects, and the comparative economist’s socialism, a family of institutional formations, can overlap substantially in extension while remaining distinct [categories](https://plato.stanford.edu/entries/natural-kinds/), each answerable to what its field needs the category to explain. Nothing in what follows requires one of them to be the real one; it requires each claim to say which category, at what scope, it concerns.

Across the pair, the labels can do three kinds of work. They can index historical formations, organize a design space by grouping recurring institutional questions, and support mechanism-based projection when a demonstrated profile recurs across relevant variants. A historical index or design-space map does not by itself warrant causal projection: neither label carries conclusions beyond the mechanism or profile the evidence supports. This distinction lets the pair retain historically central state-socialist formations while separately asking how much effective socialization they achieved.

Capitalist formations need not originate in capitalist projects. But where privatization, liberalization, market construction, or shareholder-oriented reform is deliberately pursued, the same project → implementation → mechanism → outcome sequence applies. Capitalism’s emergent origin does not exempt capitalist political projects from the implementation burden.
...
These proposed mechanisms should be compared with alternative mechanisms such as environmental pricing, regulation, commons governance, technological substitution, and public investment under other ownership systems.

## 3. Allocation mechanisms under socialism

### 3.1 Markets and dispersed knowledge

The [modern debate](https://en.wikipedia.org/wiki/Socialist_calculation_debate) opens with [Mises](https://en.wikipedia.org/wiki/Ludwig_von_Mises)’s calculation argument: without market prices for capital goods, a socialist administration cannot reduce heterogeneous production possibilities to a common cost measure, so rational allocation of producer goods becomes impossible (Mises 1920/1935). [Lange](https://en.wikipedia.org/wiki/Oskar_R._Lange)’s reply conceded the need for prices while denying that they require private ownership: a planning board could post accounting prices and adjust them by trial and error against observed shortages and surpluses (Lange 1936–1937).
...
The inference is nevertheless narrower than a defence of private ownership. [Bardhan](https://en.wikipedia.org/wiki/Pranab_Bardhan) and Roemer make the distinction explicit in their proposal for competitive socialism: they seek to preserve competitive markets while altering ownership and monitoring institutions (Bardhan and Roemer 1992).
...
At present this is more a design hypothesis than a historically demonstrated socialist system property. This evidential asymmetry with some well-developed capitalist financial architectures should be acknowledged rather than filled by aspiration.
...
The attribution test can therefore be run visibly. First, the unit is Yugoslav manufacturing enterprises in 1986, the outcome is pervasive redistribution and the resulting compression of income differences across enterprises, and the relevant comparator or counterfactual is supplied by the contrast between firms and by the question of what would have occurred under credible hardening of finance and exit; neither is directly observed as a clean experiment. Second, a mechanism is identified, and its parts have distinct owners. Kornai, Maskin, and Roland supply the theory: budget constraints soften when commitments to withhold rescue lack credibility, because the supporting organizations have done nothing to alter their vested interest in providing support (Kornai, Maskin, and Roland 2003). Kraft and Vodopivec supply the driving force: Yugoslavia’s redistributive channels differed from those of other socialist economies but shared “the pursuit of job and wage security” (Kraft and Vodopivec 1992). Third, ex post accommodation is observed: firm-level redistribution in 1986 was pervasive, large enough to compress enterprise incomes sharply, and channelled substantially through softened finance. The expectations that constitute softness in the Kornai–Maskin–Roland sense are not directly observed in the 1986 data (expectations rarely are), so the claim that termination lacked credibility is an inference from observed accommodation together with the persistence of the support relationship, not an independent measurement. The principal plausible rival is product-market suppression or another inflationary redistribution channel that does not depend on the institutional relationship identified here; the evidence distinguishes the financial channels but cannot estimate the mechanism’s magnitude separately. Fourth, the mechanism was connected to the institutional structure rather than merely to product-market suppression: social property, politically mediated wage objectives, finance, and state–enterprise paternalism persisted in a system that had already decentralized substantially, though one no longer relying primarily on market allocation. Fifth, because the claim concerns a recurring tendency, the test examines feedback and correction: Uvalić finds the protective state–enterprise relationship continuing through reforms intended to increase market discipline. Sixth, the evidence supports a limited form of robustness at the level of the objective rather than the mechanism: the redistributive channels differed from those elsewhere in Eastern European socialism while the job-and-wage-security objective recurred, which shows that the objective can recruit different institutional vehicles, not that one mechanism operated identically everywhere. The recurrence of the job-and-wage-security objective supports projection to architectures combining social responsibility for enterprise survival with finance that cannot credibly be hardened, not to socialism in general.

The framework therefore warrants a bounded verdict:

> **The evidence supports the inference that, at least by the 1980s, Yugoslavia’s self-managed market-socialist formation had materially soft enterprise budget constraints and that soft-budget accommodation, operating through social property, politically mediated job and wage security, and softened finance, was a causal contributor to the observed redistribution and compression of enterprise-income differences.**
...
The evidence is administrative rather than anecdotal. Monthly social-security records covering April 1996 to December 2005 allow worker-managed firms and conventional firms to be followed through entry, shocks, and dissolution within one legal and macroeconomic environment (Burdín and Dean 2009; Burdín 2014). Two findings matter here. Employment in worker-managed firms is inelastic to output-price shocks while pay adjusts, the reverse pattern from conventional firms; during the [2002 crisis](https://en.wikipedia.org/wiki/2002_Uruguay_banking_crisis), both types cut pay to a similar extent while worker-managed firms cut employment significantly less (Burdín and Dean 2009). And worker-managed firms were not more likely to fail: their hazard of dissolution is about 29 per cent lower than that of comparable conventional firms once microenterprises are excluded and each firm’s effective tax burden is controlled for, with about a third of the gap statistically mediated by employment stability (Burdín 2014). The tax control matters because the documented state support for cooperatives took the form of statutory tax exemptions; the survival difference survives netting it out. Neither study documents subsidy, rescue, or refinancing channels of the kind §6.6 turns on.

The attribution test runs as before. First, the unit is worker-managed and conventional firms in Uruguay over the periods studied, the outcomes are the adjustment of employment and pay under shocks and the hazard of dissolution, and the relevant comparator is the conventional-firm group observed in the same legal and macroeconomic environment. Second, the mechanism is worker-managed governance: it internalizes employment security as an objective and holds the authority to trade pay against jobs, so where no external actor accommodates losses, adjustment must come from inside the firm, on the pay margin. Third, it operated: the adjustment asymmetry is exactly what the panel shows, within firms over time, and the reported survival difference is consistent with the same mechanism. The firms were not randomly assigned to governance forms, however, and Burdín identifies self-selection of firms into industries and of workers into organizational forms as principal plausible rival explanations. The evidence therefore establishes a robust organizational association, and compatibility with market discipline, more securely than an isolated causal effect; its magnitude is reported for the dissolution hazard but not identified as a pure governance effect. Fourth, the predicted difference is connected to the institutional structure within one national legal and macroeconomic environment and survives the studies’ reported controls. Fifth, because the claim concerns compatibility with market discipline rather than a universal system tendency, correction is not a required condition; dissolution was a live outcome, and worker-managed firms experienced less of it. Sixth, robustness is limited and stated: the panel spans a severe crisis, but the survival difference is concentrated in services and not statistically significant in manufacturing or transport, and everything rests on one country’s registry.
...
The scope restriction parallels §6.6’s. The evidence does not warrant *self-management outperforms conventional ownership*, *cooperatives scale economy-wide*, or anything about socialized investment: these firms competed for members, inputs, and customers inside capitalist finance and product markets, and the sectoral concentration of the survival result is a real limit. What the pairing licenses is precise. In Yugoslavia, social responsibility for jobs and wages met finance that could not credibly be hardened, and budget constraints softened; in Uruguay, the same objective met an environment where no accommodation is documented, and it was pursued on the pay margin without a survival penalty. The comparison strongly undercuts the claim that worker self-management by itself entails soft budgets. It supports the hypothesis that the financing and rescue architecture, rather than governance form alone, determines whether employment-security objectives generate softness: the Kornai–Maskin–Roland point from §4.5 in its positive form. The pairing therefore suggests a design hypothesis: where worker governance permits adjustment through pay while finance remains external and not broadly accommodative, employment-security objectives need not generate soft budget constraints.

### 6.8 The common institutional frontier

Capitalist, socialist, and hybrid systems should be evaluated in the same evaluative space:
...
Marx, Karl. 1844/1992. “Economic and Philosophical Manuscripts (1844).” In *Early Writings*, translated by Rodney Livingstone and Gregor Benton. London: Penguin Books in association with New Left Review.

Marx, Karl. 1867/1990. *Capital: A Critique of Political Economy*, vol. 1. Translated by Ben Fowkes. London: Penguin Books in association with New Left Review.

Meidner, Rudolf, in cooperation with Anna Hedborg and Gunnar Fond. 1978. *Employee Investment Funds: An Approach to Collective Capital Formation*. London: George Allen & Unwin.

Mises, Ludwig von. 1920/1935. “Economic Calculation in the Socialist Commonwealth.” In *Collectivist Economic Planning*, edited by F. A. Hayek, translated by S. Adler. London: George Routledge & Sons.
